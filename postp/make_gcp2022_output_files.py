...
if read_input_file:
    ...
    datadir_in =  '/glade/campaign/cgd/tss/projects/TRENDY/'+trendy+'/'+sim+'/lnd/proc/tseries/month_1/'
    
    datadir_out = '/glade/campaign/cgd/tss/projects/TRENDY/'+trendy+'/'+sim+'/lnd/proc/trendy/'
